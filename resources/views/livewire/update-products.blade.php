<x-layout>
    ...
    <div class="mb-6">
        ...
        <input type="text" id="name" name="name" value="{{ $name }}" wire:model='name'
    ...
    <div class="mb-6">
        ...
        <textarea id="description" name="description" wire:model='description'
            class="outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">{{ $description }}</textarea>
        @error('description')
            <div class="text-sm text-red-600">{{ $message }}</div>
        @enderror
    </div>
    <div class="flex space-x-5 justify-between">
        <div class="mb-6 w-full">
            ...
            <input type="number" id="price" name="price" value="{{ $price }}" wire:model='price'
                class="outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            @error('price')
                <div class="text-sm text-red-600">{{ $message }}</div>
            @enderror
        ...
        <div class="mb-6 w-full">
            ...
            <input type="number" id="quantity" name="quantity" value="{{ $quantity }}" wire:model='quantity'
                class="outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            @error('quantity')
                <div class="text-sm text-red-600">{{ $message }}</div>
            @enderror
    ...
    <button type="submit" wire:click.prevent="edit({{ $product->id }})"
